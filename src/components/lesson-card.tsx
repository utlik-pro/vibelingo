...
export function LessonCard({
  ...
  return (
    <div
      className={`flex items-center gap-3.5 p-4 rounded-2xl cursor-pointer transition-all duration-200 animate-[slideIn_0.4s_ease_both] bg-white border ${
        locked
          ? "opacity-40 cursor-not-allowed border-gray-100"
          : completed
          ? "border-purple-200 shadow-[0_2px_12px_rgba(147,51,234,0.1)]"
          : "border-gray-100 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(147,51,234,0.1)] hover:border-purple-200"
      }`}
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex gap-2 items-center">
          ...
          <span className="text-[11px] text-gray-400">+{lesson.xp} XP</span>
        </div>
      </div>
